        ...
        <div className="space-y-4 animate-fade-in">
             <div className="neo-card p-5 space-y-3">
                <div className="flex items-center gap-4">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[var(--nb-primary)] text-[var(--nb-border)] dark:text-[var(--nb-bg)] font-bold text-lg border-2 border-[var(--nb-border)]">
                        <MegaphoneIcon />
                    </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-3 pt-3 border-t-2 border-dashed border-[var(--nb-border)]">
